...
import {
  crystalLightColors,
  darkDefaultColors,
  midnightAuroraColors,
  stellarNovaColors,
} from "./colors.js";

import { LightThemeTokenColors, darkThemeTokenColors } from "./tokenColors.js";

const themes = {
  crystalLight: {
    type: "light",
    name: "BXP Crystal Light",
    colors: crystalLightColors,
    plainTextColor: "#383A42",
    tokenColors: LightThemeTokenColors,
  },
  darkDefault: {
    type: "dark",
    name: "BXP Dark Default",
    colors: darkDefaultColors,
    plainTextColor: "#CDD5DF",
    tokenColors: darkThemeTokenColors,
  },
  midnightAurora: {
    type: "dark",
    name: "BXP Midnight Aurora",
    colors: midnightAuroraColors,
    plainTextColor: "#B8CFE6D5",
    tokenColors: darkThemeTokenColors,
  },
  stellarNova: {
    type: "dark",
    name: "BXP Stellar Nova",
    colors: stellarNovaColors,
    plainTextColor: "#ADBAC7",
    tokenColors: darkThemeTokenColors,
  },
};
